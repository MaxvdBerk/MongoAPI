...
var app = express();
var mongoURL = "https://mongopostpostget-nonsubstantive-cutlass.eu-gb.mybluemix.net/api/Images"; // restApiRoot (/api), localhost and port from config.json (talentimage/Mongodb/ServerMongoFoto/server/)
